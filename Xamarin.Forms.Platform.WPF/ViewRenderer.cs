...
namespace Xamarin.Forms.Platform.WPF
{
	...
	public class ViewRenderer : ViewRenderer<View, FrameworkElement>
	{
	    ...
	    {
	        this.HorizontalAlignment = Element.HorizontalOptions.ToNativeHorizontalAlignment();
	        this.VerticalAlignment = Element.VerticalOptions.ToNativeVerticalAlignment();
	    }
