...
namespace Xamarin.Forms.Platform.WPF
{
	public class SearchBarRenderer : ViewRenderer<SearchBar, FormsTextBox>
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<SearchBar> e)
		{
			...
			var phoneTextBox = new FormsTextBox { InputScope = scope };
		...
		{
			Control.Background = Element.BackgroundColor == Color.Default ? (Brush)System.Windows.Application.Current.Resources["TextBoxBrush"] : Element.BackgroundColor.ToBrush();
		}
