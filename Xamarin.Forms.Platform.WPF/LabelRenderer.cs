...
#pragma warning restore 618
	...
	public class LabelRenderer : ViewRenderer<Label, TextBlock>
	{
		...
		protected override void OnElementChanged(ElementChangedEventArgs<Label> e)
		{
			...
			var textBlock = new TextBlock { Foreground = (Brush)System.Windows.Application.Current.Resources["ForegroundBrush"] };
		...
		void UpdateColor(TextBlock textBlock)
		{
			...
			if (label != null && label.TextColor != Color.Default)
				...
				textBlock.Foreground = (Brush)System.Windows.Application.Current.Resources["ForegroundBrush"];
		}
