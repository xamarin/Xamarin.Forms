...
namespace Xamarin.Forms.Platform.WPF
{
    ...
    public class VisualElementTracker<TModel, TElement> : VisualElementTracker where TModel : VisualElement where TElement : FrameworkElement
    {
        ...
        void MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
			...
			var vr = (sender as ViewRenderer)?.Element;
            ...
            if (e.ClickCount == 2)
            {
                handled = ElementOnDoubleTap();

            }
            else
            {
                handled = ElementOnTap();
            }
            e.Handled = handled;
        }
        ...
        protected virtual void UpdateNativeControl()
        {
            ...
            UpdateVisibility(_model, _element);
        ...
        static void UpdateRotation(VisualElement view, FrameworkElement frameworkElement)
        {
            ...
            //TODO: реализвоать полноценную поддержку PlaneProjection
            ...
            //frameworkElement.RenderTransform.Projection = new PlaneProjection
            //{
