CONSOLE_PATH='packages/Xamarin.UITest.Console.0.4.1/tools/xut-console.exe'
IPA_PATH='Xamarin.Forms.ControlGallery.iOS/bin/iPhone/Debug/XamarinFormsControlGalleryiOS-1.0.ipa'
APK_PATH='Xamarin.Forms.ControlGallery.Android/bin/Debug/AndroidControlGallery.AndroidControlGallery-Signed.apk'
TEST_DIR_IOS='Xamarin.Forms.iOS.UITests/bin/Debug/'
TEST_DIR_ANDROID='Xamarin.Forms.Android.UITests/bin/Debug/'
ACCOUNT=''
...
if (( $# != 4 )); then
	...
	echo "CATEGORY options: Layout, Control, View, Page, CellsListTable, Visual, Keyboard, IssueNamed, Issue1xxToIssue4xx, Issue5xxToIssue9xx, Single"
