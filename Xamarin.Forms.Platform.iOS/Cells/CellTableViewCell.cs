...
namespace Xamarin.Forms.Platform.iOS
{
	public class CellTableViewCell : UITableViewCell, INativeElementView
	{
		...
		internal static UITableViewCell GetNativeCell(UITableView tableView, Cell cell, bool recycleCells = false, string templateId = "", bool actionCellIconInsteadOfText = false)
		{
			...
			if (cell.HasContextActions || recycleCells)
			{
				...
				if (contextCell == null)
				{
					contextCell = new ContextActionsCell(templateId, actionCellIconInsteadOfText);
