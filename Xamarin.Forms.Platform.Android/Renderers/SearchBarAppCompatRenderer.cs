...
{
	public class SearchBarAppCompatRenderer : ViewRenderer<SearchBar, SearchView>, SearchView.IOnQueryTextListener
	{
		...
		public SearchBarAppCompatRenderer(Context context) : base(context)
		{
			AutoPackage = false;
		}
		...
		public SearchBarAppCompatRenderer()
		{
			AutoPackage = false;
		}
