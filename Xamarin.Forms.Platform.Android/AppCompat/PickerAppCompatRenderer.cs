...
{
	public abstract class PickerAppCompatRendererBase<TControl> : ViewRenderer<Picker, TControl>, IPickerRenderer
		where TControl : global::Android.Views.View
	{
		...
		public PickerAppCompatRendererBase(Context context) : base(context)
		{
			AutoPackage = false;
		}
		...
		public PickerAppCompatRendererBase()
		{
			AutoPackage = false;
		}
	...
	public class PickerAppCompatRenderer : PickerAppCompatRendererBase<AppCompatEditText>
	{
		TextColorSwitcher _textColorSwitcher;
		TextColorSwitcher _hintColorSwitcher;

		[Obsolete("This constructor is obsolete as of version 2.5. Please use PickerRenderer(Context) instead.")]
		public PickerAppCompatRenderer()
		{
		}

		public PickerAppCompatRenderer(Context context) : base(context)
		{
		}
