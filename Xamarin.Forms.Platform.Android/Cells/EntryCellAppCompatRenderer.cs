...
{
	public class EntryCellAppCompatRenderer : CellRenderer
	{
		EntryCellAppCompatView _view;

		protected override global::Android.Views.View GetCellCore(Cell item, global::Android.Views.View convertView, ViewGroup parent, Context context)
		{
			if ((_view = convertView as EntryCellAppCompatView) == null)
				_view = new EntryCellAppCompatView(context, item);
			else
			{
