...
namespace Xamarin.Forms.Controls.Issues
{
	...
	[Issue(IssueTracker.Github, 7277, "Reverse CollectionView layout", PlatformAffected.All)]
	public partial class Issue7277 : TestContentPage
	{
#if APP
		int _itemCount = 10;
		...
		public Issue7277()
		{
			...
			BindingContext = new ViewModel7277();
		}
		...
		async void CollectionView_RemainingItemsThresholdReached(object sender, System.EventArgs e)
		{
			...
			try
			{
				var itemsSource = (sender as CollectionView).ItemsSource as ObservableCollection<Model7277>;
		...
		async Task<ObservableCollection<Model7277>> GetNextSetAsync()
		{
			return await Task.Run(() =>
			{
				var collection = new ObservableCollection<Model7277>();
				var count = PageSize;
				...
				{
					collection.Add(new Model7277((BindingContext as ViewModel7277).ItemSizingStrategy == ItemSizingStrategy.MeasureAllItems)
					{
						Text = i.ToString(),
		...
		{
			RunningApp.WaitForElement("CollectionView7277");

			var colView = RunningApp.Query("CollectionView7277").Single();
	...
	[Preserve(AllMembers = true)]
	public class ViewModel7277
	{
		public ObservableCollection<Model7277> Items { get; set; }
		...
		public ViewModel7277()
		{
			...
			{
				collection.Add(new Model7277(ItemSizingStrategy == ItemSizingStrategy.MeasureAllItems)
				{
					Text = i.ToString(),
					BackgroundColor = i % 2 == 0 ? Color.AntiqueWhite : Color.Lavender
				});
	...
	public class Model7277
	{
		...
		public Model7277(bool isUneven)
		{
	...
	[Preserve(AllMembers = true)]
	public class CollectionView7277 : CollectionView
	{
