...
namespace Xamarin.Platform
{
	public static class BrushExtensions
	{
		...
		public static void UpdateBackground(this UIView control, Brush2 brush)
		{
			if (control == null)
				return;
		...
		public static CALayer? GetBackgroundLayer(this UIView control, Brush2 brush)
		{
			if (control == null)
				return null;
		...
		static NSNumber[] GetCAGradientLayerLocations(List<GradientStop2> gradientStops)
		{
