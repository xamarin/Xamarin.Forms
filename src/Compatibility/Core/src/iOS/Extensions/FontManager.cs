...
namespace Microsoft.Maui.Controls.Compatibility.Platform.iOS
{
	internal class FontManager : IFontManager
	{
		...
		public UIFont GetFont(Font font)
		{
			...
			return GetFont(font.FontFamily, size, fontAttributes, CreateFont);
		}

		public UIFont GetFont(IFontElement element)
		{
			var fontFamily = element.FontFamily;
			var fontSize = (float)element.FontSize;
			var fontAttributes = element.FontAttributes;
			return GetFont(fontFamily, fontSize, fontAttributes, CreateFont);
		}
