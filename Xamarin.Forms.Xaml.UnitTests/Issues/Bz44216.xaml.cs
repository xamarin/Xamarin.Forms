...
namespace Xamarin.Forms.Xaml.UnitTests
{
	...
	public partial class Bz44216 : ContentPage
	{
		...
		class Tests
		{
			...
			{
				if (useCompiledXaml)
					Assert.Throws(new XamlParseExceptionConstraint(7, 26, s => s.StartsWith("Position 7:26. No property,", StringComparison.Ordinal)), () => MockCompiler.Compile(typeof(Bz44216)));
				else
					Assert.Throws(new XamlParseExceptionConstraint(7, 26, s => s.StartsWith("Position 7:26. Cannot assign property")), () => new Bz44216(useCompiledXaml));
			}
		}
	}
}
