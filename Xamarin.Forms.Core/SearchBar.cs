...
namespace Xamarin.Forms
{
	...
	public class SearchBar : InputView, IFontElement, IPlaceholderElement, ITextElement, ITextAlignmentElement, ISearchBarController, IFastElementConfiguration<SearchBar>
	{
