...
{
	//using FormsElement = Forms.RadioButton;

	//public static class RadioButton
	//{
	//	public static readonly BindableProperty UseDefaultPaddingProperty = BindableProperty.Create("UseDefaultPadding", typeof(bool), typeof(RadioButton), false);
	...
	//	public static readonly BindableProperty UseDefaultShadowProperty = BindableProperty.Create("UseDefaultShadow", typeof(bool), typeof(RadioButton), false);
