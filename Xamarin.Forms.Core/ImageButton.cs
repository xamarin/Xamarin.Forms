...
namespace Xamarin.Forms
{
	...
	public class ImageButton : View, IImageController, IFastElementConfiguration<ImageButton>, IBorderElement, IButtonController, IViewController, IPaddingElement, IButtonElement, IImageElement
	{
