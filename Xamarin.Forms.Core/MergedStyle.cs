	...
	public partial class VisualElement
	{
		sealed class MergedStyle : IStyle
		{
				...
				set
				{
					...
					if (_styleClass != null) {
						...
						foreach (var styleClass in _styleClass) {
							var classStyleProperty = BindableProperty.Create (nameof(ClassStyles), typeof(IList<Style>), typeof(VisualElement), default(IList<Style>),
			...
			void RegisterImplicitStyles()
			{
				...
				while (true) {
					BindableProperty implicitStyleProperty = BindableProperty.Create(nameof(ImplicitStyle), typeof(Style), typeof(VisualElement), default(Style),
