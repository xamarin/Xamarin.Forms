...
namespace Xamarin.Forms
{
	...
	public class Shell : Page, IShellController, IPropertyPropagationController, IPageContainer<Page>
	{
		...
		{
			return _navigationManager.GoToAsync(state, null, false, parameters: parameters);
		}

		internal Task GoToAsync(ShellNavigationState state, bool animate, ShellRouteParameters parameters)
		{
			return _navigationManager.GoToAsync(state, animate, false, parameters: parameters);
		}
