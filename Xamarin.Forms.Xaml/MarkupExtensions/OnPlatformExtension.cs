	...
	public class OnPlatformExtension : IMarkupExtension
	{
		...
		public object ProvideValue(IServiceProvider serviceProvider)
		{
			if (   Android == s_notset
				...
				&& WPF     == s_notset
				&& Default == s_notset) {
				throw new XamlParseException("XF0055", serviceProvider.GetLineInfo(), nameof(OnPlatformExtension));
			}
			...
			if (converterProvider != null) {
				MemberInfo minforetriever()
				{
					...
					try {
						...
						throw new XamlParseException("CS0102", serviceProvider.GetLineInfo(), e, bp.DeclaringType.ToString(), bp.PropertyName);
					}
					if (minfo != null)
						return minfo;
					try {
						...
						throw new XamlParseException("CS0102", serviceProvider.GetLineInfo(), e, bp.DeclaringType.ToString(), "Get" + bp.PropertyName);
					}
				}
